...
\section{Interpretability for understanding model behavior}
...
The complete implementation and experimental setup for this project is available at: \url{https://github.com/matei-neaga/automotive-anomaly-detection}
...
\begin{description}
    ...
    \item[\texttt{data/}] Directory for storing the AutoVI dataset and related analyses
    \begin{itemize}
        \item \texttt{data\_analysis\_report.md}: Documentation of dataset structure and statistics
    \end{itemize}
